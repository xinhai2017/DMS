...
def _get_labling_dict(image_files=None):
    ...
    for image_file in image_files:
        ...
        if image_name.startswith('drink'):
            labling_dict[image_file] = 0
        elif image_name.startswith('smoke'):
            labling_dict[image_file] = 1
        elif image_file.startswith('other'):
            labling_dict[image_file] = 2
        elif image_file.startswith('phone'):
            labling_dict[image_file] = 3
